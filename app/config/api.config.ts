...
export const getLessonsInCoursesUrl = (string: string) =>
	`/lessons-in-courses/${string}`
export const getLessonsUrl = (string: string) => `/lessons/${string}`
export const getCompletedLessonsUrl = (string: string) =>
	`/completed-lessons/${string}`
export const getLessonsInWeeksUrl = (string: string) =>
	`/lessons-in-weeks/${string}`
export const getLessonsInDaysUrl = (string: string) =>
	`/lessons-in-days/${string}`
